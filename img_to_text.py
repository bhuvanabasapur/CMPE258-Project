...
coco_inception_features_path = "/content/drive/Shareddrives/Semstyle/Semstyle/semstyle_datafiles/coco_train_v3_pytorch.pik"
coco_dataset_path = "/content/drive/Shareddrives/Semstyle/Semstyle/semstyle_datafiles/coco_dataset_full_rm_style.json"

model_path = "/content/drive/Shareddrives/Semstyle/Semstyle/models/"
...
def get_data(train=True):
    feats = pickle.load(open(coco_inception_features_path, "r"))
