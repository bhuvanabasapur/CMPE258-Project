...
rom_train_path = "/content/drive/Shareddrives/Semstyle/Semstyle/semstyle_datafiles/romance_wo_style.json"
coco_train_path = "/content/drive/Shareddrives/Semstyle/Semstyle/semstyle_datafiles/coco_dataset_full_rm_style.json"
